...
template<typename Item_type>
inline void quicksort_3_way(std::vector<Item_type> &a)
{
    quicksort_3_way<Item_type>(a, 0, static_cast<int>(a.size() - 1));
} // narrow_cast
...
inline void quicksort_3_string(std::vector<std::string> &a)
{
    quicksort_3_string(a, 0, static_cast<int>(a.size() - 1), 0);
} // narrow_cast
